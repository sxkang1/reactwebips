...
export default class WebGl extends Component {
    ...
    MouseWheel = (event) => {
        ...
        console.log('Detector.scaleMatrix---',Detector.scaleMatrix)
        console.log('Detector.translationMatri---',Detector.translationMatrix)
        //以图像中心为中心进行缩放;
                    ...
                    <Col span={10} className="">
                        ...
                        <Row style={{ marginTop: '20px' }}>
                            <Col span={24}>
                                ...
                                <Button className="btn btn-Histogram" title="Histogram" type={this.state.operationList[12].btnState}   onClick={this.handleBtnAlgorithmServices.bind(this, 'Histogram')}></Button>                               
