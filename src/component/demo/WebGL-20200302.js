...
export default class WebGl extends Component {
    ...
    GrayWindowBefore = (value) => {
        console.log('GrayWindowBefore: ', value);
    }

    GrayWindowAfter = (value) => {
        console.log('GrayWindowAfter: ', value);
    }
                ...
                <Row className="bootoms">
                    ...
                    <Col span={8}>
                        ...
                        <div className="ant-slider-div">
                            ...
                            <div style={{ display: 'flex', position: 'relative' }}>
                                <Icon type="minus" style={{ color: "#fff", marginTop: '12px' }} />
                                &nbsp;&nbsp;
                            <span style={{ display: "inline-block", color: '#fff', position: 'absolute', top: '-7px', left: '23px' }}>&nbsp;0&nbsp; </span>
                                <Slider
                                    range
                                    ...
                                    defaultValue={[50, 100]}
                                    onChange={this.GrayWindowBefore}
                                    onAfterChange={this.GrayWindowAfter}
                                />
                                <span style={{ display: "inline-block", color: '#fff', position: 'absolute', top: '-7px', right: '62px' }}>&nbsp;255&nbsp; </span>
                                &nbsp;&nbsp;
                            <Icon type="plus" style={{ color: "#fff", marginTop: '12px' }} />
                                &nbsp;&nbsp;
                            <button size="small" style={{ marginTop: '8px' }}><Icon type="reload" /></button>
                            </div>
                        </div>
                    </Col>
