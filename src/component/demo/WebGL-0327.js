                    ...
                    <Col span={10} className="">
                        <Row style={{ marginTop: '30px' }}>
                            <Col span={24}>
                                ...
                                <Button className="btn btn-sharpness" title=""  style={{ margin: '0 20px' }} ></Button>
                                <Button className="btn btn-sharpness" title=""  ></Button>
                                <Button className="btn btn-sharpness" title=""  style={{ margin: '0 20px' }} ></Button>
                            </Col>
                        </Row>
                        ...
                        <Row style={{ marginTop: '20px' }}>
                            <Col span={24}>
                                ...
                                <Button className="btn btn-edgeDetect5" title="edgeDetect2" type={this.state.operationList[5].btnState} style={{ margin: '0 20px' }} onClick={this.handleBtnClick.bind(this, 'edgeDetect5')}></Button>
