        ...
        if (operaionType === 'Revert') {
            ...
            operaions.forEach((item) => {
                ...
                if (operaionType === item.name) {
                    ...
                    // if(operaionType === 'Reverse'){
                    //     if(item.using){
                    //         this.imagesPath = "http://127.0.0.1:80/Image/tempImage/B48E52FD-9911-4D68-A4F6-78A946A6FD38-1.jpg";
                    //     }
                    //     else{
                    //         this.imagesPath = "http://127.0.0.1:80/Image/tempImage/B48E52FD-9911-4D68-A4F6-78A946A6FD38.jpg";
                    //     }
