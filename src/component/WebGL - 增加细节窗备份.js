...
export default class WebGl extends Component {
    ...
    handleBtnAlgorithmServices = (operaionType) => { //例如："histogram"
        ...
        let params = {
            ...
            'operators': {
                ...
                'PseudoColorize': {
                    'IsEnabled': this.flag,
                    'Options': operaionType == "histogram" ? 'gray': operaionType
                },
    ...
    MouseWheel = (event) => {
        ...
        var tempX = (this.refs.canvas.width - Detector.scaleMatrix[0] * this.image.width) / 2;
        var tempY = (this.refs.canvas.height - Detector.scaleMatrix[1] * this.image.height) / 2;
        //var x = event.clientX, y = event.clientY;
